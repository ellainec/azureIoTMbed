...
#define LPTICKER_DELAY_TICKS                                                  4                                                                                                // set by target:NUCLEO_L496ZG
#define MBEDTLS_USER_CONFIG_FILE                                              "azure_mbedtls_config.h"                                                                         // set by application
#define MBED_CONF_APP_BG96_DEBUG                                              0                                                                                                // set by application
#define MBED_CONF_APP_BG96_DEBUG_SETTING                                      0                                                                                                // set by application
#define MBED_CONF_APP_BUTTON_ACTIVE_STATE                                     ActiveHigh                                                                                       // set by application
#define MBED_CONF_APP_CONFIG_COMMENTS                                         Add the to the macros section above to enable memory stats output                                // set by application
#define MBED_CONF_APP_HEAP_STATS                                              MBED_HEAP_STATS_ENABLED                                                                          // set by application
#define MBED_CONF_APP_IKSVERSION                                              2                                                                                                // set by application
#define MBED_CONF_APP_NETWORK_INTERFACE                                       CELLULAR_BG96                                                                                    // set by application
#define MBED_CONF_APP_STACK_STATS                                             MBED_STACK_STATS_ENABLED                                                                         // set by application
#define MBED_CONF_APP_TELUSKIT                                                1                                                                                                // set by application
#define MBED_CONF_APP_THREAD_STATS                                            MBED_THREAD_STATS_ENABLED                                                                        // set by application
...
// Macros
#define BG96_LIBRARY_READ_TIMEOUTMS                                           30000                                                                                            // defined by application
#define DEFAULT_APN                                                           "m2m-east.telus.iot"                                                                             // defined by application
